...
const GithubLogo = (props: any) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" className="duration-150 fill-black dark:fill-white dark:hover:fill-primary-80 hover:fill-primary-20">
