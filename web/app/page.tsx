...
import { allPublishedArticles } from "@common/mdxLoader";
  ...
  return (
    <>
      ...
      <div className="latest-posts">
        <h2 className="display-medium font-semibold mb-5">Latest posts</h2>
        <ul className="flex flex-col gap-4">{postCards}</ul>
      </div>
    </>
  );
};
